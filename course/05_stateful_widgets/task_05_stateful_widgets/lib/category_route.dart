...
class CategoryRoute extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => new _CategoryRouteState(
...
class _CategoryRouteState extends State<CategoryRoute> {
  ...
  _CategoryRouteState({@required this.categoryNames, @required this.baseColors})
      : assert(categoryNames != null),
        assert(baseColors != null);
